...
def save_charging_records(charging_records_dict, average_travelled_distance, average_time_spent_travelling, average_time_spent_waiting, total_average_travelled_distance, total_average_time_spent_travelling, total_average_time_spent_waiting):
    ...
    if os.path.exists(Constants.Data.PROCESSED_OUPUT_CHARGING_RECORDS_FILE_PATH):
        os.remove(Constants.Data.PROCESSED_OUPUT_CHARGING_RECORDS_FILE_PATH)

    # Save results to file
    with open(Constants.Data.PROCESSED_OUPUT_CHARGING_RECORDS_FILE_PATH, "w") as file:
...
def save_dead_cars(average_battery_level):
    # Delete the file if it already exists
    if os.path.exists(Constants.Data.PROCESSED_OUPUT_DEAD_CARS_FILE_PATH):
        os.remove(Constants.Data.PROCESSED_OUPUT_DEAD_CARS_FILE_PATH)

    # Save results to file
    with open(Constants.Data.PROCESSED_OUPUT_DEAD_CARS_FILE_PATH, "w") as file:
...
def main():
    ...
    charging_records_file_path = Constants.Data.RAW_OUPUT_CHARGING_RECORDS_FILE_PATH
    ...
    dead_cars_file_path = Constants.Data.RAW_OUPUT_DEAD_CARS_FILE_PATH
